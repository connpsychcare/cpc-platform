...
const CampaignsPage = () => {
  return (
    <ListPage
      ...
      filterConfig={[
        { key: "status", label: "Status", options: ["draft", "scheduled", "sent", "failed"] },
        { key: "audience", label: "Audience", options: [{ value: "allUsers", label: "All Users" }, { value: "patients", label: "Patients" }, { value: "providers", label: "Providers" }, { value: "staff", label: "Staff" }, { value: "custom", label: "Custom" }] },
      ]}
    />
  );
};
