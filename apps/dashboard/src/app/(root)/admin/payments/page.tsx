...
export default function PaymentsPage() {
  return (
    <ListPage
      ...
      filterConfig={[
        { key: "status", label: "Status", options: ["pending", "succeeded", "failed", "refunded"] },
        { key: "provider", label: "Provider", options: ["stripe", "paypal", "manual"] },
        { key: "methodType", label: "Method", options: [{ value: "card", label: "Card" }, { value: "wallet", label: "Wallet" }, { value: "bankTransfer", label: "Bank Transfer" }, { value: "cash", label: "Cash" }] },
      ]}
    />
  );
}
