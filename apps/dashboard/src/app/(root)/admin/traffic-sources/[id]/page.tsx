...
const getContactMessageName = (
  message: NonNullable<TrafficSourceResponse["contactMessages"]>[number],
) => [message.firstName, message.lastName].filter(Boolean).join(" ");

const TrafficSourceDetailsPage = ({ params }: PageProps<"/admin/traffic-sources/[id]">) => {
