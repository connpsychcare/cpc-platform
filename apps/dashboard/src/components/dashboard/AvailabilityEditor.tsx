...
import { useReplaceProviderAvailability } from "@/hooks/availability";
...
const AvailabilityEditor = ({
  ...
  const { replaceAvailability, isPending } =
    useReplaceProviderAvailability(providerId);
          ...
          >
            <div className="flex items-center justify-between lg:block">
              <div>
                ...
                <p className="text-xs text-muted-foreground">Provider slots</p>
              </div>
