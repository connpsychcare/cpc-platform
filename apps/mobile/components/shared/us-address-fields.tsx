...
// Static list avoids importing the heavy country-state-city library on every render
const US_STATES = [
...
interface USAddressFieldsProps {
  form: any;
  stateFieldName: string;
  cityFieldName: string;
}

export function USAddressFields({ form, stateFieldName, cityFieldName }: USAddressFieldsProps) {
  return (
    <>
      <SelectField
        form={form}
