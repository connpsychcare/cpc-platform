...
export default function StaffPaymentDetailRoute() {
    ...
    <InternalScreen>
      ...
      >
        <View className="section-wrapper gap-6 pt-6">
          ...
          <SectionCard title="Payment Details" className="shadow-soft" contentClassName="gap-0">
          ...
          {(p as any).patient?.user?.displayName || (p as any).order?.id ? (
            <SectionCard title="Associated With" className="shadow-soft" contentClassName="gap-0">
