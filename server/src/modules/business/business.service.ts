...
import type {
  ...
  BranchQueryDto,
  BusinessProfileDto,
} from "@workspace/contracts/business/dto";
...
export class BusinessService {
  ...
  async listBranches(query: BranchQueryDto) {
    ...
    const missingIncludeIds = getMissingIncludeIds(branches, includeIds);
    const forcedBranches = missingIncludeIds.length
      ...
      : [];
    const mergedBranches = mergeIncludedRows(branches, forcedBranches);
