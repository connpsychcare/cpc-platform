...
const getFieldValue = <TData extends BaseResponse>(
  field: DetailFieldConfig<TData>,
  data: TData,
) => {
...
interface GenericDetailsSectionsProps<TData extends BaseResponse> {
  data: TData;
  sections: SectionConfig<TData>[];
}

export function GenericDetailsSections<TData extends BaseResponse>({
  data,
  sections,
}: GenericDetailsSectionsProps<TData>) {
  return (
...
interface GenericDetailsPageProps<TData extends BaseResponse> {
  ...
  renderBelowHeader?: (data: TData) => React.ReactNode;
  ...
  return (
    <section className="space-y-6">
      <div className="flex flex-col gap-8 mb-8">
        ...
        {renderBelowHeader?.(data)}
      </div>

      <GenericDetailsSections data={data} sections={sections} />
