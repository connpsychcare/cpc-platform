...
export type EmailTemplateMap = {
  ...
  authorizationAlert: Pick<EmailTemplateBaseProps, "user" | "message">;

  sessionNoteAdded: Pick<EmailTemplateBaseProps, "user" | "message">;

  treatmentPlanUpdated: Pick<EmailTemplateBaseProps, "user" | "message">;

  testimonialRequest: Pick<EmailTemplateBaseProps, "user" | "message">;
};
